...
@section('title', 'Bienvenido a Cachi Shop' )
...
<div class="header header-filter" style="background-image: url('{{ asset('/img/city.jpg') }}');">
    <div class="container">
        <div class="row">
            <div class="col-md-6">
                <img src="{{ asset('/img/logo2.png') }}" alt="Distribuidora de nochea y Día" width="300">
                <h1 class="title">Bienvenido a Cachi shop V.1.1</h1>
        ...
        <div class="section text-center section-landing">
            <div class="row">
                <div class="col-md-8 col-md-offset-2">
                    <h2 class="title">¿Por qué confiar en cachi shop?'</h2>
